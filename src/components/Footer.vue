                ...
                <div class="col-lg-3 col-md-6">
                    <div class="sidebar-widget wow fadeInUp animated mb-30">
                        ...
                        <div class="textwidget">
                            ...
                            <div><strong class="color-black">Address</strong><br>
                                123 Main Street<br>
                    ...
                    <div class="sidebar-widget widget_newsletter wow fadeInUp animated mb-30" data-wow-delay="0.3s">
                        ...
                        <div class="newsletter">
                            ...
                            <form class="input-group form-subcriber mt-30 d-flex">
                                ...
                                <label class="mt-20"> <input class="mr-5" name="name" type="checkbox" value="1" > I agree to the <a href="#" target="_blank">terms &amp; conditions</a> </label>
                            </form>
                        </div>
                    </div>
                </div>
